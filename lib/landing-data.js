...
export const testimonial = {
  quote: "We identified $1.38M in at-risk dues within the first two weeks. Three members we thought were happy were quietly disengaging — Swoop caught what our team couldn't see across disconnected systems.",
  author: 'General Manager',
  org: 'Based on Pinetree CC pilot data',
  note: 'Projection based on pilot environment with 300 members and real integration data.',
};
...
export const teamMembers = [
  {
    name: 'Tyler Hayes',
    title: 'CEO',
    background: 'Club technology operator. Built and scaled SaaS platforms serving the private club industry for 10+ years.',
  },
  {
    name: 'Jordan Mitchell',
    title: 'CTO',
    background: 'Former engineering lead at a top hospitality-tech company. ML/AI specialist with deep experience in behavioral prediction systems.',
  },
  {
    name: 'Alex Chen',
    title: 'Head of Product',
    background: 'Product leader from enterprise SaaS. Obsessed with turning complex operational data into simple, actionable workflows.',
  },
];
