...
const categories = [
  {
    ...
    icon: '⛳',
    systems: 'Leading tee sheet & demand platforms',
  ...
  },
  {
    title: 'Point of Sale',
    icon: '🧾',
    systems: 'Traditional club & POS suites',
  ...
  },
  {
    ...
    icon: '👥',
    systems: 'Membership CRMs & engagement hubs',
  ...
  },
  {
    ...
    icon: '✉️',
    systems: 'Email, SMS, and marketing automation',
  ...
  },
  {
    ...
    icon: '📅',
    systems: 'Scheduling, labor, and staffing intelligence',
  ...
  },
  {
    ...
    icon: '📈',
    systems: 'Accounting, finance, and payments infrastructure',
