    ...
    <LandingShell>
      <SectionShell band="cream" eyebrow="Legal" title="Privacy Policy">
        <div style={{ maxWidth: 720, margin: '0 auto', lineHeight: 1.7 }}>
          ...
          <p>We collect club operational data (tee sheet, POS, CRM) only as authorized by the General Manager. Member PII is processed under a mutual NDA and never shared across engagements.</p>
          ...
          <h3>Security</h3>
          <p>AES-256 encryption at rest. TLS 1.3 in transit. SOC 2 Type II (Audit Active).</p>
          <h3>Contact</h3>
